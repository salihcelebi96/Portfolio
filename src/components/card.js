...
const ProjectGallery = () => {
  ...
  return (
    <div>
      <div className="project-list grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 mx-3 my-5">
            ...
            <CardHeader>
              <div className='h-80 w-full p-4'>
                ...
                <a className='' href={project.url} target="_blank" rel="noopener noreferrer">
                  ...
                  {showInfo === index && (
                    <div className={`hv transition-transform duration-300 gap-5  ease-in-out absolute inset-0 bg-gray-800 bg-opacity-90 h-full  flex flex-col items-center justify-center px-5  text-xl  ${showInfo === index ? 'h-full' : ''}`}>
